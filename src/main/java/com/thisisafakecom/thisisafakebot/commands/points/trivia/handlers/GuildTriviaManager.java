...
public class GuildTriviaManager {
	...
	public void createSession() {
		...
		try {
            ...
            // should do some error checking based on the response code it gets back (from the api)
	...
	public ArrayList<TriviaQuestion> getVideogameQuestions(){
		...
		if (token == null) {
			...
			// use the token to grab results - if token does not exist then create a new token
			CloseableHttpClient client = HttpClients.createDefault();
			try {
